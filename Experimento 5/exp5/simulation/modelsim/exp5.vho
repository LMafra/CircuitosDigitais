...
-- Equation(s):
-- \inst2~0_combout\ = (\SW~combout\(3)) # ((\SW~combout\(2) & ((\SW~combout\(0)) # (\SW~combout\(1)))))
...
-- Equation(s):
-- \inst7~combout\ = (\SW~combout\(2)) # ((\SW~combout\(0) & \SW~combout\(1)))
...
-- Equation(s):
-- \inst16~0_combout\ = (\SW~combout\(2) & ((!\SW~combout\(1)) # (!\SW~combout\(0)))) # (!\SW~combout\(2) & ((\SW~combout\(1))))
...
-- Equation(s):
-- \inst24~combout\ = (\SW~combout\(2) & (((!\SW~combout\(1))))) # (!\SW~combout\(2) & ((\SW~combout\(1)) # ((!\SW~combout\(3) & \SW~combout\(0)))))
